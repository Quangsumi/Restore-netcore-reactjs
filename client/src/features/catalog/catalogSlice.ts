...
import { RootState } from '../../app/stores/configureStore';
...
export const catalogSlice = createSlice({
    ...
    reducers: {
        ...
        setProduct: (state, action) => {
            productsAdapter.upsertOne(state, action.payload); // unnessesary
            state.productsLoaded = false;
        },
        removeProduct: (state, action) => {
            productsAdapter.removeOne(state, action.payload); // unnessesary
            state.productsLoaded = false;
        }
    },
